  ...
  return (
    <section className="text-gray-600 body-font h-screen relative">
      <div className="grid grid-cols-1">
        <div className="grid grid-rows-1 h-32 hidden md:flex"></div>
          ...
          <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
            <div className="text-center lg:w-2/3 w-full">
              ...
              <div className="flex justify-center">
                <button className="inline-flex font-bold text-Primary border text-2xl border-Primary py-2 px-6 focus:outline hover:text-Primary-hover hover:border-Primary-hover rounded">
