    ...
    <div id="Portfolio" ref={observe} className="mt-8 px-8 pt-8">
        ...
        <section className="text-gray-400 body-font">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-700 sm:flex-row flex-col">
                    <div className={`${inView? `animate-fade-in-right-1` : ``} flex-grow sm:text-left text-center mt-6 sm:mt-0`}>
                    ...
                    <div className={`${inView? `animate-fade-in-left-1` : ``} sm:w-32 sm:order-none order-first sm:h-32 h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full border-t-8 border-r-2 border-gray-700 flex-shrink-0`}>
                        <img className="sm:w-16 sm:h-16 w-10 h-10" src="/instagram-logo.png" alt=""/>
                    </div>
                </div>
                <div className={`flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col`}>
                    <div className={`${inView? `animate-fade-in-right-2` : ``} sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full border-t-8 border-l-2 border-gray-700 text-indigo-500 flex-shrink-0`}>
                        <img className="sm:w-16 sm:h-16 w-10 h-10" src="/department.png" alt=""/>
                    </div>
                    <div className={`${inView? `animate-fade-in-left-2` : ``} flex-grow sm:text-left text-center mt-6 sm:mt-0`}>
